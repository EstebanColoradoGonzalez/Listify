...
object Queries {
    ...
    const val SELECT_SHOPPING_LISTS = "SELECT * FROM shopping_list ORDER BY date DESC"
    ...
    const val UPDATE_SHOPPING_LIST = "UPDATE shopping_list SET date = :newDate WHERE id = :id"
